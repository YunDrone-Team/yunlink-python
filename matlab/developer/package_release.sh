...
bundle_dir="$root/dist/yunlink-sunray-matlab-1.3.1-bundle"
zip_file="$root/dist/yunlink-sunray-matlab-1.3.1-bundle.zip"
...
(
  cd "$root/dist"
  zip -r "yunlink-sunray-matlab-1.3.1-bundle.zip" "yunlink-sunray-matlab-1.3.1-bundle"
)
